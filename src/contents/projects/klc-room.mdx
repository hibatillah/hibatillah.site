...
variant: "website"
stacks:
  ["Next.js", "React", "Typescript", "NextAuth", "Prisma ORM", "Mysql", "Tailwind CSS", "Shadcn UI"]
headline: "Ministry's Unit's room management system."
...
import thumbnail from "@/static/project/klc-room/thumbnail.webp"

<ImageFrameGrid className="mb-8 w-fit mx-auto">
	<ImageFrame offset="c" transform="rotate" className="col-span-full sm:h-80">
		<Image src={thumbnail} alt="Ministry Unit Room Management" placeholder="blur" className="object-top" />
	</ImageFrame>
</ImageFrameGrid>
