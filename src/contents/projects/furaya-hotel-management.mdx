...
import thumbnail from "@/static/project/furaya-hotel/thumbnail.webp"

<ImageFrameGrid className="mb-8 w-fit mx-auto">
	<ImageFrame offset="c" transform="rotate" className="col-span-full sm:h-80">
		<Image src={thumbnail} alt="Furaya Hotel Management System" placeholder="blur" className="object-top" />
	</ImageFrame>
</ImageFrameGrid>
