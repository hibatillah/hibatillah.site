...
import graduation from "@/static/edu/pcr/1.jpg"
...
My third year landed me a spot in MSIB Batch 6, a national internship program that's tough to get into, and through it I took a <TextLink href="/work/frontend-ministry-finance">Front End Developer</TextLink> role at the Ministry of Finance in Jakarta.
...
<ImageFrameGrid className="my-8 w-fit mx-auto">
	<ImageFrame offset="c" transform="rotate" className="col-span-full sm:h-80 rotate-1">
		<Image src={graduation} alt="Hibatillah's Graduation" placeholder="blur" />
	</ImageFrame>
</ImageFrameGrid>
