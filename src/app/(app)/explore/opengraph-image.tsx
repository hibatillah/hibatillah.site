...
export const alt = "Explore | Hibatillah Hasanin"
		...
		<div tw="relative flex h-full w-full flex-col overflow-hidden bg-black px-12 py-20 text-white">
			<div tw="flex h-full flex-col justify-between">
				<div tw="flex flex-col">
					<h1 tw="text-5xl leading-normal font-bold tracking-tight text-white">Explore</h1>
					<p tw="-mt-2 text-3xl leading-snug text-neutral-400">
						Discover various interesting stacks and technologies
					</p>
				</div>

				<div tw="flex flex-row justify-between">
					<div tw="text-2xl font-semibold">Explore | Hibatillah Hasanin</div>
