	...
	return (
		<Link
			...
			className={cn(
				...
				"underline decoration-current/50 underline-offset-4 data-[underline=hover]:decoration-transparent data-[underline=hover]:hover:decoration-current data-[underline=none]:no-underline",
